...
library.add_group(LegitTab, "Aimbot", function()
    ...
    library.text("FOV Color"); library.same_line()
    COL3("Aim Bot%%FOV Circle Color", "Color##ab_fovc")
    ...
    library.text("Dead FOV Color"); library.same_line()
    COL3("Aim Bot%%Dead FOV Circle Color", "Color##ab_dfovc")
end)
...
library.add_group(LegitTab, "Silent", function()
    ...
    library.text("FOV Color"); library.same_line()
    COL3("Silent Aim%%FOV Circle Color", "Color##si_fovc")
    ...
    library.text("Dead FOV Color"); library.same_line()
    COL3("Silent Aim%%Dead FOV Circle Color", "Color##si_dfovc")
end)
...
library.add_group(LegitTab, "Backtrack", function()
    ...
    library.text("Char Color"); library.same_line()
    COL3("Backtracking%%Character Color", "Color##bt_col")
    ...
    library.text("Color"); library.same_line()
...
library.add_group(VisTab, "EnemyESP", function()
    ...
    library.text("Box Color"); library.same_line()
    COL3("Enemy ESP%%Box Color", "Color##esp_boxc")
    SI("Enemy ESP%%Box Opacity", "Box Opacity##esp_boxo", 1, 100, "%i%%")
    T("Enemy ESP%%Box Outlines", "Box Outlines##esp_boxol")
    library.text("Outline Color"); library.same_line()
    COL3("Enemy ESP%%Box Outline Color", "Color##esp_boxolc")
    SI("Enemy ESP%%Box Outline Opacity", "Outline Opacity##esp_boxolo", 1, 100, "%i%%")
    T("Enemy ESP%%Fill Boxes", "Fill Boxes##esp_fill")
    library.text("Fill Color"); library.same_line()
    COL3("Enemy ESP%%Box Inside Color", "Color##esp_fillc")
    SI("Enemy ESP%%Box Inside Opacity", "Fill Opacity##esp_fillo", 1, 100, "%i%%")
    T("Enemy ESP%%Health Bar", "Health Bar##esp_hp")
    library.text("Dmg Color"); library.same_line()
    COL3("Enemy ESP%%Damage Color", "Color##esp_dmg")
    library.text("HP Color"); library.same_line()
    COL3("Enemy ESP%%Health Color", "Color##esp_hpc")
    T("Enemy ESP%%Health Bar Outline", "HP Outline##esp_hpo")
    library.text("HP Outl Color"); library.same_line()
    COL3("Enemy ESP%%Health Outline Color", "Color##esp_hpoc")
    T("Enemy ESP%%Tracers", "Tracers##esp_tr")
    library.text("Tracer Color"); library.same_line()
    COL3("Enemy ESP%%Tracer Color", "Color##esp_trc")
    SI("Enemy ESP%%Tracer Opacity", "Tracer Opacity##esp_tro", 1, 100, "%i%%")
    T("Enemy ESP%%Tracer Outlines", "Tracer Outlines##esp_trol")
    library.text("Tr Outl Color"); library.same_line()
    COL3("Enemy ESP%%Tracer Outline Color", "Color##esp_trolc")
    ...
    library.text("Names Color"); library.same_line()
    COL3("Enemy ESP%%Names Color", "Color##esp_nmc")
    T("Enemy ESP%%Weapons", "Weapons##esp_wp")
    library.text("Weapons Color"); library.same_line()
    COL3("Enemy ESP%%Weapons Color", "Color##esp_wpc")
    T("Enemy ESP%%Distances", "Distances##esp_di")
    library.text("Dist Color"); library.same_line()
    COL3("Enemy ESP%%Distances Color", "Color##esp_dic")
    T("Enemy ESP%%Health Percents", "Health Pct##esp_hpp")
    library.text("HP Num Color"); library.same_line()
    COL3("Enemy ESP%%Health Number Color", "Color##esp_hpnc")
    T("Enemy ESP%%Text Outlines", "Text Outlines##esp_txo")
    T("Enemy ESP%%Highlight Chams", "Highlight Chams##esp_hl")
    library.text("HL Outline"); library.same_line()
    COL3("Enemy ESP%%Highlight Outline Color", "Color##esp_hloc")
    library.text("HL Fill"); library.same_line()
    COL3("Enemy ESP%%Highlight Fill Color", "Color##esp_hlfc")
...
library.add_group(VisTab, "Chams", function()
    ...
    library.text("Arm Color"); library.same_line()
    COL3("Chams%%Arm Color", "Color##ch_armc")
    ...
    library.text("Gun Color"); library.same_line()
    COL3("Chams%%Gun Color", "Color##ch_gunc")
    ...
    library.text("Char Color"); library.same_line()
    COL3("More Chams%%Character Color", "Color##mc_c")
    ...
    library.text("Amb Color"); library.same_line()
    COL3("World Visuals%%Ambient Color", "Color##wv_ambc")
    TKEY("World Visuals%%Bullet Tracers", "Bullet Tracers##wv_tr", "tr_key")
    library.text("Color One"); library.same_line()
    COL3("World Visuals%%Color One", "Color##wv_c1")
    library.text("Color Two"); library.same_line()
    COL3("World Visuals%%Color Two", "Color##wv_c2")
    ...
    library.text("Points Color"); library.same_line()
    COL3("World Visuals%%Points Color", "Color##wv_ptc")
